...
const Home = () => {
    ...
    useEffect(()=> {
        ...
        let notificationChannel = supabase.channel('notifications').on('postgres_changes', {event: 'INSERT', schema: 'public', table: 'notifications', filter: `recieverId=eq.${user.id}`, handleNewNotification}).subscribe();
